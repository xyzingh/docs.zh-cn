...
| <span data-ttu-id="73879-212">Blazor 服务器应用</span><span class="sxs-lookup"><span data-stu-id="73879-212">Blazor Server App</span></span>                            | [<span data-ttu-id="73879-213">blazorserver</span><span class="sxs-lookup"><span data-stu-id="73879-213">blazorserver</span></span>](#blazorserver)   | <span data-ttu-id="73879-214">[C#]</span><span class="sxs-lookup"><span data-stu-id="73879-214">[C#]</span></span>         | <span data-ttu-id="73879-215">Web/Blazor</span><span class="sxs-lookup"><span data-stu-id="73879-215">Web/Blazor</span></span>                            | <span data-ttu-id="73879-216">3.0</span><span class="sxs-lookup"><span data-stu-id="73879-216">3.0</span></span>        |
| <span data-ttu-id="73879-217">Blazor WebAssembly 应用</span><span class="sxs-lookup"><span data-stu-id="73879-217">Blazor WebAssembly App</span></span>                       | [<span data-ttu-id="73879-218">blazorwasm</span><span class="sxs-lookup"><span data-stu-id="73879-218">blazorwasm</span></span>](#blazorwasm)       | <span data-ttu-id="73879-219">[C#]</span><span class="sxs-lookup"><span data-stu-id="73879-219">[C#]</span></span>         | <span data-ttu-id="73879-220">Web/Blazor/WebAssembly</span><span class="sxs-lookup"><span data-stu-id="73879-220">Web/Blazor/WebAssembly</span></span>                | <span data-ttu-id="73879-221">3.1.300</span><span class="sxs-lookup"><span data-stu-id="73879-221">3.1.300</span></span>    |
...
- **`-ho|--hosted`**
  ...
  <span data-ttu-id="73879-475">包括 Blazor WebAssembly 应用的 ASP.NET Core 主机。</span><span class="sxs-lookup"><span data-stu-id="73879-475">Includes an ASP.NET Core host for the Blazor WebAssembly app.</span></span>
